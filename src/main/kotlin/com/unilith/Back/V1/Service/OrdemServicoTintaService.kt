...
import com.unilith.Back.V1.Repository.OrdemServicoTintaRepository
...
@Service
class OrdemServicoTintaService {


    @Autowired
    lateinit var repository: OrdemServicoTintaRepository
    ...
    fun findAll(page: Optional<Int>, dataIni: Optional<Date>, dataAte: Optional<Date>): List<OrdemServicoAcabamentoVo> {
        ...
        val lista:List<OrdemServicoTinta> = repository.findAll()
    ...
    fun findById(id: Long): OrdemServicoAcabamentoVo {
        ...
        val ordemServico: OrdemServicoTinta = repository.findById(id).orElseThrow({ ResourceNotFoundException("Objeto não Encontrado") });
    ...
    fun create(ordemServicoVo: OrdemServicoAcabamentoVo?): OrdemServicoAcabamentoVo {
        ...
        val ordermServico: OrdemServicoTinta = mapper.parseObject(ordemServicoVo, OrdemServicoTinta::class.java);
    ...
    fun createAll(lista:List<OrdemServicoAcabamentoVo> ): List<OrdemServicoAcabamentoVo>{
        ...
        val listaOrdemServicoAcabamento = mapper.parseListObject(lista, OrdemServicoTinta::class.java)
